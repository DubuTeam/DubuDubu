...
<link href="${pageContext.request.contextPath}/resources/css/test.css"
	...
	<div class="container-fluid">
		...
		<div id="btn-bom">
			...
			<label for="search">제품명</label> <input type="text">
			<button>검색</button>
		...
		<form class="p_Process2" style="float: right;">
			...
			<div class="main">
				...
				<div class="tab">
					<label for="tab-1">제품정보</label> <label for="tab-2">공정흐름</label>
