<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/prodcss/indicaSearch.css"
								...
								<tbody>
									...
									<tr>
										...
										<td style="height: 55px"><input class="form-check-input"
											...
											value="지시"> 지시 <input class="form-check-input"
											type="radio" name="status" value="미지시"> 미지시</td>
										<th></th>
										<td></td>
										<th></th>
										<td></td>
									...
									<tr>
										...
										<td><input type="text" style="width: 150px"
											class="form-control" id="name" name="name"></td>
										<th></th>
										<td></td>
										<th></th>
										<td></td>
