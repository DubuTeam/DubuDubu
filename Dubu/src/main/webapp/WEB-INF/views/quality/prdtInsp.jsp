						...
						<div class="tab">
							<nav>
								<div class="nav-tabs" id="nav-tab" role="tablist">
									<label class="nav-link" id="nav-insp-tab" data-bs-toggle="tab"
										data-bs-target="#nav-insp" type="button" role="tab" aria-controls="nav-insp"
										aria-selected="true" for="tab-1">제품검사
										등록</label>
									<label class="nav-link" id="nav-info-tab" data-bs-toggle="tab"
										...
										aria-selected="false" for="tab-2">제품검사 조회</label>
								</div>
							</nav>
						</div>
						<div class="content">
									...
									<table class="table" style="vertical-align : middle;">
										...
										<tbody>
											<tr>
												...
												<td><input class="form-control" type="text" id="orderNo" name="orderNo"
														style="width: 250px" maxlength="20" placeholder="주문서를 조회해주세요"
														readonly />
													<!-- Button trigger modal -->
													<!-- Button trigger modal (4.6버젼) -->
													<button type="button" style="margin-left: 3px"
														class="btn btn-primary" data-toggle="modal"
														data-target="#exampleModal222" id="searchBtn" name="searchBtn">
														...
														<div class="modal-dialog modal-dialog-centered modal-lg">
															...
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title" id="exampleModalLabel">주문서
																		목록</h5>
																...
																<div class="modal-body" style="text-align: center;">
																	<div style="display: flex; margin-bottom: 10px;">
																		<span
																			style="display: flex; align-items: center;">거래처명</span>
																		<input type="text" style="margin: 0px 5px;"
																			id="modal-searchEqpName" name="eqpName"
																			placeholder="설비명"
																			style="width: 180px"></input>

																		<button type="button" id="sTtn"
												...
												<td><input class="form-control" type="text" id="edctsCd" name="edctsCd"
														style="width: 250px" maxlength="20" readonly /></td>
												<th>완제품명 </th>
												<td><input class="form-control" type="text" id="edctsNm" name="edctsNm"
														style="width: 250px" maxlength="50" readonly /></td>
											</tr>
											<tr>
												<th>완제품LOT <strong class="blue">*</strong></th>
												<td><input class="form-control" type="text" id="edctsLotNo1"
														name="edctsLotNo1" style="width: 250px" maxlength="50"
														readonly /></td>
												<th>검사수량</th>
												<td><input class="form-control" type="text" id="inspCnt" name="inspCnt"
														style="width: 250px" maxlength="50" readonly /></td>
												<th></th>
												<td></td>
											</tr>
											<tr>
												<th>검사일자</th>
												<td><input class="form-control" type="date" id="inspDt" name="inspDt"
												...
												<td><select class="dataTable-selector" name="inspJm" id="inspJm"
														style="width: 250px">
														<option selected value="">==선택==</option>
														<option value="적합">적합</option>
														<option value="적합">부적합</option>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="content-dis">
								<div class="linelist" style="float: right;">
									<button type="button" style="width: 85px; height: 38px; margin-bottom: 4px"
										class="btn btn-primary" id="selectBtn">
										<i class="fas fa-search"></i> 조회
									</button>

									<button type="submit" formaction="eqmOprExelView"
										style="width: 85px; height: 38px; margin-bottom: 4px" class="btn btn-primary"
										id="excelBtn">
											...
											<table class="table" style="vertical-align : middle;">
												...
												<tbody>
													<tr>
														...
														<td colspan="3">
															<input class="form-control" type="date" id="startDt"
																name="startDt" style="width: 250px" maxlength="20" />
															&nbsp; ~ &nbsp;
															<input class="form-control" type="date" id="endDt"
																name="endDt" style="width: 250px" maxlength="20" />
														</td>
														<th>
														<td></td>
														</th>
