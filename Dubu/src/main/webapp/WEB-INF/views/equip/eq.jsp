								...
								<table class="table" style="vertical-align: middle;">
									...
									<tbody>
										<tr>
											...
											<th>설비명 *</th>
											<td>
												<input class="form-control" type="text" id="eqmNm" name="eqmNm" style="width: 250px">
											</td>
										</tr>
										...
										<tr>
											<th>공정명 *</th>
											<td>
												<select name="prcsNm" aria-label="Default select example" style="width: 250px" id='prcsNm' class="dataTable-selector">
													<option selected value="">==등록시필수선택==</option>
										...
										<tr>
											<th>입고일자 *</th>
											<td>
												<input class="form-control" type="date" id="eqmIstDt" name="eqmIstDt" style="width: 250px" />
											</td>
