...
<link
	href="${pageContext.request.contextPath}/resources/css/eqcss/eqLine"
						...
						<form id="dataForm" action="#">
							<div class="mb-3">
								<label for="no" class="form-label">라인코드</label> <input
									type="text" th:value="${lineCode.lineCd}" readonly
									class="form-control" id="lineCd" name="lineCd">
							</div>
							<div class="mb-3"></div>
							<div class="mb-3">
								<label for="id" class="form-label">라인명</label> <input
									type="text" class="form-control" id="lineNm" name="lineNm">
							</div>
							<div class="mb-3">
							...
							<div class="mb-4">
								<label for="email" class="form-label">사용여부</label><br> <input
									type="radio" name="useYn" value="Y"> 사용
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
